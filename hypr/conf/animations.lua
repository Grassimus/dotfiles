...
-- hl.animation({ leaf = "layers", enabled = true, speed = 2, bezier = "menu_decel", style = "slide" })
...
-- hl.animation({ leaf = "specialWorkspaces", enabled = true, speed = 3, bezier = "md3_decel", style = "slidefadevert 15%" })
